...
<li class='mt-2 '><code>s</code> consists of parentheses only <code class="text-md">'()[]{}'</code>.</li>`,
	...
	order: 4,
	languageSupports: [
		{title :'js', starterCode: `function validParentheses(s) {
			// Write your code here
		  };`}, {title: 'python', starterCode: `def validParentheses(s):
		  # Write your code here`}, 
		{title: 'java', starterCode: `public static boolean validParentheses(String s) {
			// Write your code here}`}]
};
